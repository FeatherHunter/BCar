...
{	
  ...
  {			
		...
		else if(uart_receive=='w')	Flag_Qian=1,Flag_Hou=0;//,Flag_Left=0,Flag_Right=0;//////////////前
		else if(uart_receive=='s')	Flag_Qian=0,Flag_Hou=1;//,Flag_Left=0,Flag_Right=0;//////////////后
		else if(uart_receive=='a'||uart_receive==0x43||uart_receive==0x44)	
														//Flag_Qian=0,Flag_Hou=0,
														Flag_Left=0,Flag_Right=1;  //右
		else if(uart_receive=='d'||uart_receive==0x47||uart_receive==0x48)	    //左
														//Flag_Qian=0,Flag_Hou=0,
