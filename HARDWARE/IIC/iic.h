/* CopyRight 2015~2025 王辰浩 qq975559549
 * Author：WCH  Version：1.0 Date：2015/11/13
 * Filename: iic.h
 * Description: iic bus 相关各种配置函数
 * Function List: 
 ...
 *  7.void IIC_Send_Byte(u8 sdb);
 *  8.u8 IIC_Read_Byte(unsigned char ack); //iic读取一个byte
 */
